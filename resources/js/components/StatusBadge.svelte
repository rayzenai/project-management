<script lang="ts">
    let { status, label }: { status: string | null | undefined; label?: string | null } = $props();
...
<span class="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-medium ring-1 ring-inset {klass}">
