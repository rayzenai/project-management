                ...
                {#each projects as project (project.slug)}
                    ...
                    >
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="mt-1.5 flex h-1.5 w-full overflow-hidden rounded-full bg-surface-alt">
                            ...
                            <div class="mt-1 text-xs text-fg-muted">
                                ...
                                {#if project.stalled > 0}· <span class="text-danger">{project.stalled} stalled</span>{/if}
                        ...
                        <div class="shrink-0 text-right">
                            <div class="text-lg font-bold text-success">{project.percent_complete}%</div>
                            <div class="text-[10px] tracking-wider text-fg-faint uppercase">complete</div>
                        </div>
                    </a>
                {:else}
                    <p class="px-4 py-6 text-sm text-fg-muted">No projects yet.</p>
                {/each}
            </div>
        </section>
        ...
        <aside>
            ...
            <div class="rounded-xl border border-line bg-surface p-2">
                {#each recent_activity as item (item.id)}
                    <div class="border-b border-line-soft px-2 py-2.5 last:border-0">
                ...
                {:else}
                    <p class="px-2 py-6 text-sm text-fg-muted">No recent activity.</p>
                {/each}
            </div>
        </aside>
    </div>
