...
export const NOTE_COLORS: WorkspaceNoteColor[] = ['amber', 'rose', 'sky', 'emerald', 'violet'];
...
export const paperClass: Record<WorkspaceNoteColor, string> = {
    ...
    emerald: 'bg-emerald-200/95 border-emerald-300 dark:bg-emerald-400/20 dark:border-emerald-400/30',
